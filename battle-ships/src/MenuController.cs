...
static class MenuController
{
	...
	private static void DrawButtons(int menu, int level, int xOffset)
	{
		...
		for (i = 0; i <= _menuStructure[menu].Length - 1; i++) {
            ...
            SwinGame.DrawText(GameController.GetDifficulty(), SwinGame.RGBAColor(2, 167, 252, 255), GameResources.GameFont("Menu"), SwinGame.ScreenWidth() - 60, SwinGame.ScreenHeight() - 40);

...
/// <summary>
/// The AIEasyPlayer is a type of AIPlayer where it will randomly target tiles
/// on the map in the hopes of destroying an enemy ship. If an enemey ship is hit,
/// it will continue to randomly shoot instead of attempting to continue to destroy that ship.
/// </summary>
